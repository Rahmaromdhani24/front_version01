...
private void terminerChargement(ActionEvent event ) {
	...
	String codeControlerSelectionAuNouveau = SoudureInformationsCodeB.codecontroleselectionner ; 
	if(codeControlerSelectionAuNouveau.equals("B")) {

 try {
        // Charger le fichier FXML pour la fenêtre de chargement
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Front_java/SoudureUltrason/RemplirFormCodeB/RemplirFormCodeB.fxml"));
        Scene loadingScene = new Scene(loader.load());

        // Ajouter le fichier CSS
        String cssPath = "/Front_java/SoudureUltrason/RemplirFormCodeB/RemplirFormCodeB.css";
