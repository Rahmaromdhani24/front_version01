...
import Front_java.SertissageNormal.RemplirSertissageNormal;
...
public class LoadingSertissageNormal {
   ...
   @FXML
    ...
    private RemplirSertissageNormal parentController; // Référence vers la fenêtre mère

    public void setParentController(RemplirSertissageNormal parentController) {
        this.parentController = parentController;
    }
    
    @FXML
    public void terminerChargement() {
        SertissageNormaleInformations.testTerminitionCommande = 1;
